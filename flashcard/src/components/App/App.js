...
let dummyDataSet = [
  {
    usertitle: "useState",
    fact: "Allows you to manage state in a functional component. Makes it easier to manage and update state in response to user interactions or other events. Helps keep your component code organized by separating concerns",
    uniqueId: 0,
  },
  {
    usertitle: "useEffect",
    fact: "Is a React Hook that allows you to perform side effects in a functional component, such as fetching data from an API, updating the DOM, or subscribing to an event, after rendering has occurred.",
    uniqueId: 1,
  },
  {
    usertitle: "CSS",
    fact: "CSS, or Cascading Style Sheets, is a language used to describe the presentation of HTML and XML documents.",
    uniqueId: 2,
  },
];
  ...
  return (
    <div>
      <div className="App">
        ...
        <div
          className="riddler" /*src = "../../Images/Riddler-removebg.png" alt="riddler Photo"*/
        ></div>
        ...
        <button onClick={clearFacts} className="clearFactsButton">
          Clear Facts
        </button>
      </div>
    </div>
